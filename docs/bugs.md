...
- The GitLab OAuth authorization service does not
  have a way to sign out of a third-party application.
  Even if a user signs out of DTaaS, GitLab still shows the user as signed in.
  The next time the sign in button is clicked on the DTaaS page,
  ...
  Thus the user needs to sign out of two places, namely DTaaS and GitLab,
