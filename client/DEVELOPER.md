...
A ready-made container with Node, yarn and the rest of the toolchain
is available; see
...
| `local.js`              | Used by the `developer/check/docker-compose.yml` to set up and run the complete DTaaS application on the developer computer                                                 |
